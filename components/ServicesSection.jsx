...
export default function ServicesSection() {
  ...
  return (
    <section
      id="services"
      className="py-20 px-6 md:px-20 bg-[#001C53]"
    >
      ...
      <motion.div
        ...
        className="grid md:grid-cols-4 gap-8 justify-center"
      >
        {services.map((service, i) => (
          ...
          >
            ...
            >
              ...
              {/* TITLE */}
              <h4 className="text-lg font-semibold text-[#002861]">{service.title}</h4>
