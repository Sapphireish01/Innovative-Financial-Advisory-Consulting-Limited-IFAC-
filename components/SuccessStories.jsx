...
export default function SuccessStories() {
  ...
  return (
    <section
      id="success"
      className="py-20 px-6 md:px-12 lg:px-20 bg-[#001C53] text-white"
    >
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 md:mb-4">
        Our Impactful Success Stories
      </h2>

      <p className="text-center text-sm md:text-base text-gray-300 max-w-2xl mx-auto mb-12 md:mb-14">
      ...
      >
        ...
        <motion.div
          variants={card}
          className="bg-white text-[#011B42] p-8 md:p-10 rounded-lg shadow-lg"
        >
          ...
          <p className="text-sm leading-relaxed text-gray-700">
            ...
            financially excluded sectors of the Nigerian economy.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm leading-relaxed text-gray-700">
            Secured mandate for a mortgage bank seeking to raise ₦8 billion in
            equity capital to convert its licence to a regional commercial bank
            and fund growth and expansion.
          </p>
        </motion.div>
      </motion.div>
    </section>
